  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(sheetVariants({ side }), "border-border p-6", className)}
        {...props}
      >
        {children}
        <SheetPrimitive.Close className="absolute top-4 right-4 rounded-full p-1.5 opacity-70 transition-opacity hover:opacity-100 hover:bg-accent focus-visible:ring-2 focus-visible:ring-ring focus:outline-none disabled:pointer-events-none">
